...
make -j2 O=out ARCH=arm64 CC=clang CLANG_TRIPLE=aarch64-linux-gnu- CROSS_COMPILE=aarch64-linux-gnu- CROSS_COMPILE_ARM32=~/kernel/toolchain/gcc-32/bin/arm-linux-androideabi-
echo
